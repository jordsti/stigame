...
MVector2::MVector2(int m_x, int m_y) : Vector2(m_x, m_y) 
{

}

MVector2::MVector2(int m_length, Angle *m_angle) : Vector2(m_length, m_angle) 
{

}

/*MVector2::MVector2(int m_length, double m_angle) : Vector2(m_length, m_angle) 
{
